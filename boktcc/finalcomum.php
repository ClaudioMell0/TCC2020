...
<body>
  <style>
    body{
      background: linear-gradient(180deg, #46E2C9 0%, #008F76 99.48%), linear-gradient(180deg, #46E2C9 0%, #008F76 99.48%);
...
<!--Cabeçalho-->  
 ...
 <ul style="margin-top: 10px;
    ...
    color: #ffffff;
    line-height: 75px;">
     <p style="font-size:22px;color:white;"> <strong>Seu jogo chegou ao fim! </strong> </p> 
