...
if($_SESSION['perguntas_sorteadas'] == ""){
    ...
    $query = "SELECT * FROM tb_perguntas WHERE st_materia = 'portugues' ORDER BY RAND() limit 1";
}else{
...
<form name="form1" method="POST" action="PergComumPort.php" style="margin-top:10%; margin-left:-25%;" id="form">
