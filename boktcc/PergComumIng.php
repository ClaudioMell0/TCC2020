...
if($_SESSION['perguntas_sorteadas'] == ""){
    ...
    $query = "SELECT * FROM tb_perguntas WHERE st_materia = 'ingles' ORDER BY RAND() limit 1";
}else{
    $query = "SELECT * FROM tb_perguntas WHERE st_materia = 'ingles' and id_perguntas not in (" .  $_SESSION['perguntas_sorteadas'] . ") ORDER BY RAND() limit 1";
}
...
<form name="form1" method="POST" action="PergComuming.php" style="margin-top:10%; margin-left:-25%;" id="form">
